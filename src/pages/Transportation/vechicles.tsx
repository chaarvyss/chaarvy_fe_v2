...
const Vehicles = () => {
  ...
  const handleCreateVehicleClick = () => {
    alert('Open create vehicle form in drawer')
  }

  const handleFilteredVehicles = (params?: FilterProps) => {
      ...
      render: () => (
        <Box sx={{ alignItems: 'center', display: 'flex', flexDirection: 'row', gap: '1rem' }}>
          <Box sx={{ flexDirection: 'column' }}>
            <Typography sx={{ fontWeight: 500, fontSize: '0.875rem !important' }}>Vehicle Name</Typography>
  ...
  return (
    <ChaarvyTable
      tableTitleHeaderProps={{
        ...
        onButtonClick: handleCreateVehicleClick,
        showFilterIcon: true,
        stats: vehicle_stats,
